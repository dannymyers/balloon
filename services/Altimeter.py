...
def pres2alt(pressure):
    ...
    TemperatureAtZeroInKelvin = 285.928
    LapseRate = -0.0065
    PressureAtZero = 102020.18
    GasConstantForAir = 287.053
    Gravity = 9.80665

    alt = (TemperatureAtZeroInKelvin/LapseRate)* (((pressure/PressureAtZero)**(-LapseRate*GasConstantForAir/Gravity)) -1)
...
altitudeInMeters = pres2alt(pressure * 100) * 3.28084
#altitudeInMeters = pres2alt(85910) * 3.28084
...
print "Altitude : %.2f feet " %altitudeInMeters
